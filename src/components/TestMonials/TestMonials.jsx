        ...
        <section>
            <div className='max-w-[1400px] px-10 mx-auto py-20'>
                ...
                <div className=' flex justify-end  mt-5 py-5 gap-x-3'>
                    <button className=' custom-prev text-2xl rounded-lg w-11 h-11 justify-center flex items-center bg-zinc-100 hover:bg-gradient-to-b hover:from-orange-500 hover:text-white cursor-pointer '>
                        <IoIosArrowBack />
                    </button>
                    <button className=' custom-next text-2xl rounded-lg w-11 h-11 justify-center flex items-center bg-zinc-100 hover:bg-gradient-to-b hover:from-orange-500 hover:text-white cursor-pointer'>
                        <IoIosArrowForward />
                    </button>
                </div>
